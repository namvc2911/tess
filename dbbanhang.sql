...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th10 24, 2017 lúc 05:29 AM
...
INSERT INTO `bill_details` (`id`, `bill_id`, `product_id`, `quantity`, `unit_price`, `created_at`, `updated_at`) VALUES
...
INSERT INTO `news` (`id`, `title`, `content`, `user_id`, `view`, `image`, `create_at`, `update_at`) VALUES
(1, 'Kiếm hiệp kim dung', 'Anh hùng xạ điêu 2', 1, 8, 'sample1.jpg', '2017-11-24 02:23:50', '0000-00-00 00:00:00'),
(2, 'Tam quốc diễn nghĩa', 'Đại Chiến Xích Bích ', 2, 2, 'sample2.jpg', '2017-11-24 02:01:25', '0000-00-00 00:00:00'),
(3, 'Thủy Hử', 'Võ Tòng đại chiến\r\n ', 62, NULL, 'sample3.jpg', '2017-11-23 07:41:14', '0000-00-00 00:00:00'),
(7, 'Truyện tranh', 'Kiếm hiệp2', NULL, 2, '', '2017-11-24 02:04:33', '0000-00-00 00:00:00'),
(8, 'Tuổi hồng thơ ngây', 'Hải Nam', NULL, NULL, '', '2017-11-23 04:41:34', '0000-00-00 00:00:00'),
(12, 'Anh Hùng Xạ Điêu', 'Kiếm hiệp Kim Dung', NULL, 2, '', '2017-11-24 02:47:35', '0000-00-00 00:00:00');
...
INSERT INTO `products` (`id`, `name`, `type_id`, `description`, `unit_price`, `promotion_price`, `image`, `unit`, `new`, `created_at`, `updated_at`) VALUES
...
(1, 'InitMigrations', 'Migrations', '2017-11-24 05:19:26'),
(2, 'ConvertVersionToClassNames', 'Migrations', '2017-11-24 05:19:26'),
(3, 'IncreaseClassNameLength', 'Migrations', '2017-11-24 05:19:27'),
(4, 'N', 'app', '2017-11-24 05:23:52'),
(5, 'Namvu', 'app', '2017-11-24 05:24:56');
...
INSERT INTO `users` (`id`, `name`, `email`, `username`, `password`, `facebook_id`, `date_created`, `date_updated`) VALUES
(2, 'Nguyễn Quốc Sử', 'nqsu381@gmail.com', 'nongdanit2', '$2a$10$RJX6k5GCxNuTzsD6FtBzQe8F.aQgMbX/QeKKM4G5nAGsTyyanCsTK', NULL, '2013-10-31 03:24:42', '2017-11-24 03:46:30'),
(66, '19', 'nam@gmail.com', 'namvu', '$2a$10$UaWsSUgxRSb4DCRNeGC6TuOXH4gtL3wy4C9vArHukIoCirRoOc6ta', NULL, '2017-11-23 06:46:44', '2017-11-23 06:46:44'),
(1, 'nam vũ', 'namvc@mobgame.vn', 'nampro', '$2a$10$elx87YiKaVhh7vgAKwC.T.j/TpwR.K35mCUZvFyiDZTRHcqFpq3Ei', NULL, '2017-11-22 11:13:15', '2017-11-24 03:46:44'),
(67, 'namhoa', '123a@gmail.com', 'nongdan', '$2a$10$3qKe0CDLRWNIvxdu05pcDe3eKAdpqX9bGk3hltg8GAY40HxPNh2Su', NULL, '2017-11-23 07:44:28', '2017-11-23 07:44:28');
